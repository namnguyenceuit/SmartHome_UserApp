...
import com.uit.ce.smart_home.activities.AlertFireActivity;
import com.uit.ce.smart_home.activities.AlertGasActivity;
import com.uit.ce.smart_home.activities.Call114Activity;
import com.uit.ce.smart_home.activities.ClearFireAlarmActivity;
import com.uit.ce.smart_home.activities.ClearGasAlarmActivity;
...
public class HomeController extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mac_address = ConnectServerService.user.getHomes().get(0).getMacAddr();
